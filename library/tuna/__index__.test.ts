...
// ------------------------------------------------------------------------------------------------
function tunaSandboxParams({ orderId, cardHolderName }) {
...
// ------------------------------------------------------------------------------------------------
export { tunaSandboxPaymentActions, tunaSandboxParams };

const { customer, order } = tunaSandboxParams({ orderId: '2028', cardHolderName: tunaSandboxPaymentActions.Captured });
// ------------------------------------------------------------------------------------------------